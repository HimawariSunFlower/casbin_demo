...
//			db.Model(&model.Permission{}).Omit("pid", "status", "icon", "hidden").Create(routerCopy)
//		} else {
//			db.Model(&model.Permission{}).Where("id = ?", permissionModel.ID).Updates(routerCopy)
//		}
//	}
//}
//
